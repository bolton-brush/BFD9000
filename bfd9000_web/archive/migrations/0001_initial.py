    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "city",
                    models.CharField(
                        blank=True, help_text="City or locality", max_length=128
                    ),
                ),
                (
                    "district",
                    models.CharField(
                        blank=True, help_text="District or county", max_length=128
                    ),
                ),
                (
                    "state",
                ...
                (
                    "postal_code",
                    models.CharField(
                        blank=True, help_text="Postal or ZIP code", max_length=32
                    ),
                ),
                (
                    "country",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "system",
                    models.URLField(help_text="Code system URL", max_length=255),
                ),
                (
                    "version",
                    models.CharField(
                        blank=True, help_text="Code system version", max_length=64
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="Code value in the code system", max_length=128
                    ),
                ),
                (
                    "display",
                    models.CharField(
                        blank=True,
                        help_text="Human-readable label for this code",
                        max_length=255,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(
                        help_text="Human-readable collection name", max_length=255
                    ),
                ),
                (
                    "curator",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Institution responsible for the collection, associated with the curator",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Narrative description of collection scope",
                    ),
                ),
                (
                    "start_date",
                    models.DateField(
                        blank=True,
                        help_text="Date of the first record in this collection",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Date of the last record in this collection",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manufacturer",
                    models.CharField(
                        blank=True, help_text="Manufacturer name", max_length=255
                    ),
                ),
                (
                    "model_number",
                    models.CharField(
                        blank=True, help_text="Model number", max_length=128
                    ),
                ),
                (
                    "version",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="One-based sequence within (encounter, record_type) among DigitalRecords. Auto-assigned on first save. Used in identifier_str suffix.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "record_type",
                    models.ForeignKey(
                        help_text="CWRU record type code (e.g. L, SM). Must match physical_record.record_type when physical_record is set.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actual_period_start",
                    models.DateField(
                        blank=True, help_text="Encounter start date", null=True
                    ),
                ),
                (
                    "actual_period_start_raw",
                    models.CharField(
                        blank=True,
                ...
                (
                    "actual_period_end",
                    models.DateField(
                        blank=True, help_text="Encounter end date", null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "system",
                    models.URLField(help_text="Identifier system URL", max_length=255),
                ),
                (
                    "value",
                    models.CharField(
                        help_text="Identifier value in the given system", max_length=128
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "study_instance_uid",
                    models.CharField(
                        blank=True, help_text="DICOM StudyInstanceUID", max_length=64
                    ),
                ),
                (
                    "endpoint",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of facility or location", max_length=255
                    ),
                ),
                (
                    "address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="One-based sequence within (encounter, record_type). Auto-assigned on first save. Used in identifier_str suffix.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "series_instance_uid",
                    models.CharField(
                        blank=True, help_text="DICOM SeriesInstanceUID", max_length=64
                    ),
                ),
                (
                    "description",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Administrative gender for the subject. Values align with FHIR Patient.gender: https://hl7.org/fhir/patient-definitions.html#Patient.gender",
                        max_length=16,
                    ),
                ),
                ...
                (
                    "humanname_family",
                    models.CharField(
                        blank=True, help_text="Family name", max_length=128, null=True
                    ),
                ),
                (
                    "humanname_given",
                    models.CharField(
                        blank=True, help_text="Given name", max_length=128, null=True
                    ),
                ),
                (
                    "notes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Computable ValueSet name", max_length=255
                    ),
                ),
                (
                    "title",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Version string for this ValueSet",
                        max_length=64,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Publication status (e.g., active, draft)",
                        max_length=32,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="Documentation URL for this ValueSet",
                        max_length=255,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="Documentation URL for the code system",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Status of the underlying code system",
                        max_length=32,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="archive.ValueSetConcept",
                to="archive.coding",
            ),
        ),
        migrations.AddIndex(
            model_name="coding",
            index=models.Index(
                fields=["system", "code"], name="archive_cod_system_409408_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["short_name"], name="archive_col_short_n_e6a50d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="endpoint",
            index=models.Index(
                ...
                name="archive_end_status_c47360_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="archivelocation",
            index=models.Index(
                fields=["digital_record"], name="archive_arc_digital_eac006_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="archivelocation",
            index=models.Index(
                fields=["endpoint"], name="archive_arc_endpoin_4ce4be_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="archivelocation",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["system", "value"], name="archive_ide_system_b084a9_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="identifier",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["encounter"], name="archive_ima_encount_87a220_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="imagingstudy",
            index=models.Index(
                fields=["study_instance_uid"], name="archive_ima_study_i_8a5e48_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="physicallocation",
            index=models.Index(
                fields=["cabinet", "shelf", "slot"],
                name="archive_phy_cabinet_ebca88_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="physicalrecord",
            index=models.Index(
                fields=["encounter"], name="archive_phy_encount_51d24c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="series",
            index=models.Index(
                fields=["imaging_study"], name="archive_ser_imaging_9a7561_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="digitalrecord",
            index=models.Index(
                fields=["series"], name="archive_dig_series__e0a896_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subject",
            index=models.Index(
                fields=["birth_date"], name="archive_sub_birth_d_27a084_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="subject",
            index=models.Index(
                fields=["humanname_family", "humanname_given"],
                name="archive_sub_humanna_b4f190_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="encounter",
            index=models.Index(
                fields=["subject", "actual_period_start"],
                name="archive_enc_subject_8b72f2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="valuesetconcept",
            index=models.Index(
                fields=["valueset", "coding"], name="archive_val_valuese_ac2edd_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="valuesetconcept",
